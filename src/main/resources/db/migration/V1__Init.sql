...
--
-- -- Bảng users
-- INSERT INTO `users` (`id`, `full_name`, `username`, `password`, `phone`, `date_of_birth`, `note`, `role_id`, `status`)
-- VALUES  ('user_001', 'Nguyễn Văn A', 'nguyenvana', 'hashed_password_1', '0901234567', '1990-05-15', 'Nhân viên mới', 1, 1),
...
--
-- -- Bảng trucks
-- INSERT INTO `trucks` (`driver_id`, `license_plate`, `capacity`, `note`, `type`, `status`)
-- VALUES
...
-- INSERT INTO `schedule_configs` (`id`, `place_a`, `place_b`, `amount`, `note`)
-- VALUES
...
--
-- -- Bảng schedules
-- INSERT INTO `schedules` (`id`, `schedule_config_id`, `truck_license`, `mooc_license`, `departure_time`, `arrival_time`, `note`, `type`, `status`)
-- VALUES
...
-- INSERT INTO `expenses_configs` (`id`, `type`, `note`)
-- VALUES
...
--
-- -- Bảng expenses
-- INSERT INTO `expenses` (`id`, `schedule_id`, `expenses_config_id`, `amount`, `note`, `img_path`, `status`)
-- VALUES
...
INSERT INTO `salary` (`user_id`, `period`, `phone_allowance`, `basic_salary`, `job_allowance`, `bonus`, `monthly_paid_leave`, `ot`, `received_snn`, `union_contribution`, `travel_expenses_reimbursement`, `mandatory_insurance`, `trade_union`, `advance`, `error_of_driver`, `deduction_snn`) VALUES

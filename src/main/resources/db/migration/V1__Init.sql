...
INSERT INTO `salary` (
    `user_id`, `period`,
    `phone_allowance`, `basic_salary`, `job_allowance`, `bonus`,
    `monthly_paid_leave`, `ot`, `received_snn`, `union_contribution`,
    `travel_expenses_reimbursement`,
    `mandatory_insurance`, `trade_union`, `advance`, `error_of_driver`,
    `deduction_snn`
) VALUES
      (     'user_001', '2024-12',
            12.0, 12.0, 12.0, 12.0,
